...
public class SimpleOomage implements Oomage {
    ...
    public boolean equals(Object o) {
        if (o.getClass() == this.getClass()) {
            ...
            if (red == oomage.red && green == oomage.green && blue == oomage.blue) {
                return true;
            }
        }
        return false;
    ...
    @Override
    public int hashCode() {
        // If not using perfect hash, sum RGB values.
        // Otherwise, divide RGB values by 5 to avoid multiples of 5 and improve distribution.
        if (!USE_PERFECT_HASH) {
